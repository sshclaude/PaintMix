/**
 * CIE 1931 2° observer and D65 illuminant data at 400–700 nm, 10 nm step (31 bands).
 *
 * Range matches the Golden spectrophotometer dataset (400–700 nm).
 * The omitted tails (380–390 nm, 710–730 nm) contribute < 0.3% of Y_n
 * and are negligible for visible colour matching.
 */

export const NM_MIN = 400;
export const NM_STEP = 10;
export const N_BANDS = 31; // 400, 410, ... 700

// CIE 1931 2° CMFs: x̄, ȳ, z̄  (source: CIE 1931 standard tables, 400–700 nm)
export const CMF_X = new Float64Array([
  0.014310, 0.043510, 0.134380, 0.283900, 0.348280, 0.336200, 0.290800, 0.195360, 0.095640,
  0.032010, 0.004900, 0.009300, 0.063270, 0.165500, 0.290400, 0.433450, 0.594500, 0.762100,
  0.916300, 1.026300, 1.062200, 1.002600, 0.854450, 0.642400, 0.447900, 0.283500, 0.164900,
  0.087400, 0.046770, 0.022700, 0.011359,
]);

export const CMF_Y = new Float64Array([
  0.000396, 0.001210, 0.004000, 0.011600, 0.023000, 0.038000, 0.060000, 0.090980, 0.139020,
  0.208020, 0.323000, 0.503000, 0.710000, 0.862000, 0.954000, 0.994950, 0.995000, 0.952000,
  0.870000, 0.757000, 0.631000, 0.503000, 0.381000, 0.265000, 0.175000, 0.107000, 0.061000,
  0.032000, 0.017000, 0.008210, 0.004102,
]);

export const CMF_Z = new Float64Array([
  0.067850, 0.207400, 0.645600, 1.385600, 1.747060, 1.772110, 1.669200, 1.287640, 0.812950,
  0.465180, 0.272000, 0.158200, 0.078250, 0.042160, 0.020300, 0.008750, 0.003900, 0.002100,
  0.001650, 0.001100, 0.000800, 0.000340, 0.000190, 0.000050, 0.000020, 0.000000, 0.000000,
  0.000000, 0.000000, 0.000000, 0.000000,
]);

// CIE D65 relative spectral power distribution (normalised, 400–700 nm)
export const D65 = new Float64Array([
   82.7549,  91.4860,  93.4318,  86.6823, 104.865,  117.008,  117.812,  114.861, 115.923,
  108.811,  109.354,  107.802,  104.790,  107.689,  104.405,  104.046,  100.000,  96.3342,
   95.7880,  88.6856,   90.006,   89.599,   87.699,   83.289,   83.699,   80.027,  80.215,
   82.278,   78.284,   69.721,   71.609,
]);
...
/** W[0..2][0..30] — spectral weighting matrix for XYZ (normalised, D65). */
